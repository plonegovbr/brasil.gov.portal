...
* Corrige erro na visualização de notícias com área de porlets, ou outras páginas
  que utilizem o seletor CSS div.width-1:2. (closes `#303`_).
  [finnicius]
...
.. _`#304`: https://github.com/plonegovbr/brasil.gov.portal/issues/304